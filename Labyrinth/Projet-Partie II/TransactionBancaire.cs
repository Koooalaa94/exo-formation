...
namespace Projet_Partie_I
{
    public class TransactionBancaire
    {
        ...
        public void StatutTransaction(string sttsPath, string metroPath)
        {
            transactionFait = new List<int>();
            int compteurNbTrans = 0;
            int compteurNbTransOK = 0;
            int compteurNbTransKO = 0;
            decimal MontantTotTransOK = 0;
            ...
            using (StreamWriter writer = new StreamWriter(metroPath))
            writer.WriteLine($"Statistique : \n Nombre de transactions : {compteurNbTrans} \n Nombre de réussites : {compteurNbTransOK} \n Nombre d'echecs : {compteurNbTransKO} \n Montant total des réussites : {MontantTotTransOK}");
